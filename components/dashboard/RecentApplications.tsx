...
const getStatusBadgeClass = (status: string) => {
  ...
  if (["tarjous", "offer"].includes(s))
    return "bg-emerald-50/50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-300 border-emerald-100 dark:border-emerald-500/20";
  if (["hylätty", "hylätyt", "rejected", "päättyneet"].includes(s))
    return "bg-red-50/50 dark:bg-red-500/10 text-red-600 dark:text-red-300 border-red-100 dark:border-red-500/20";
  if (["ei vastausta", "no response"].includes(s))
    return "bg-slate-50/50 dark:bg-slate-500/10 text-slate-600 dark:text-slate-300 border-slate-100 dark:border-slate-500/20";
