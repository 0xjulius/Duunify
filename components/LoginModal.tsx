...
export default function LoginModal({ isOpen, onClose }) {
  ...
  return (
    <div
      ...
      style={{ background: "rgba(13, 11, 38, 0.7)", backdropFilter: "blur(6px)" }}
      onClick={onClose}
    >
      <style>{`
            ...
            <div className="relative p-8 md:p-12 flex flex-col justify-center">
              ...
              >
                ...
                <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
                  <TextField label="Sähköpostiosoite" type="email" placeholder="etunimi@yritys.fi" />
                  <TextField label="Salasana" type="password" placeholder="••••••••" />
                  <PrimaryButton label="Kirjaudu sisään" />
                </form>
                <SwitchLine
          ...
          >
            <div className="relative p-8 md:p-12 flex flex-col justify-center order-2 md:order-1">
              ...
              >
                ...
                <Divider label="tai" />
                <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
                  <TextField label="Koko nimi" type="text" placeholder="Maija Meikäläinen" />
                  <TextField label="Sähköpostiosoite" type="email" placeholder="etunimi@yritys.fi" />
                  <TextField label="Salasana" type="password" placeholder="Vähintään 8 merkkiä" />
                  <PrimaryButton label="Luo tunnus" />
                </form>
                <SwitchLine
...
function BrandPanel({ side, serial, eyebrow, heading, tagline, footer, className = "" }) {
  return (
    <div
