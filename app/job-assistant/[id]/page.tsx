...
export default function ResultPage({
  ...
  // Lukitus ref tuplakutsujen estämiseksi
    ...
    async function loadDataAndGenerate() {
      ...
      try {
        ...
        if (existingLetter) {
          ...
          // Generoidaan kirje vain, jos sitä ei jo luoda parhaillaan
  ...
  async function generateLetterWithGemini(currentJob: JobDetail) {
    // Jos pyyntö on jo käynnissä, poistutaan heti (estää tuplakutsut)
    ...
    try {
      ...
      setGenerating(false);
      isGeneratingRef.current = false; // Vapautetaan lukitus suorituksen päätyttyä
    }
  }
